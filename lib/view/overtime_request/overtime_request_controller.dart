...
class OvertimeRequestController extends GetxController {
  ...
  submitLeaveRequest() async {
    ...
    final data = await Service().submitOvertimeRequest(OvertimeRequest(_homeCt.userData.value.id, form.value.overtimeDate, form.value.reason, form.value.startHour, form.value.endHour, form.value.attachment));
