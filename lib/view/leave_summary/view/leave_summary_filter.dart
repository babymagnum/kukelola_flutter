...
class LeaveSummaryFilter extends StatelessWidget {

  var _leaveSummaryFilterCt = Get.find<LeaveSummaryFilterController>();
            ...
            child: Obx(() => Column(
              ...
              children: [
                ...
                InputTap(
                  ...
                  onTap: () => _showDatePicker(context, _leaveSummaryFilterCt.startDate.value, (date) {
                    _leaveSummaryFilterCt.setStartDate(date);
                  }),
                  rightIcon: '',
                  leftSize: Size(14.w, 16.h),
                  value: _leaveSummaryFilterCt.startDate.value,
                ...
                InputTap(
                  ...
                  onTap: () => _showDatePicker(context, _leaveSummaryFilterCt.endDate.value, (date) {
                    _leaveSummaryFilterCt.setEndDate(date);
                  }),
                  rightIcon: '',
                  leftSize: Size(14.w, 16.h),
                  value: _leaveSummaryFilterCt.endDate.value,
                  leftIcon: 'assets/images/fa-solid_calendar-day.svg',
                ),
                SizedBox(height: 24.h,),
                Row(
                  children: [
                    Expanded(
                      child: ButtonLoading(
                        ...
                        loading: false,
                        verticalPadding: 7.h,
                        onTap: () => _leaveSummaryFilterCt.filter(),
                    ...
                    Expanded(
                      child: ButtonLoading(
                        ...
                        loading: false,
                        verticalPadding: 7.h,
                        onTap: () => _leaveSummaryFilterCt.reset(),
                        textStyle: ThemeTextStyle.biryaniSemiBold.apply(fontSizeDelta: 10.ssp, color: Colors.white),
                      ),
                    ),
                  ],
