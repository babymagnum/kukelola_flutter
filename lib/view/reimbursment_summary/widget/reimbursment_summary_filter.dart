...
class ReimbursmentSummaryFilter extends StatelessWidget {

  var _rembursmentSummaryFilterCt = Get.find<ReimbursmentSummaryFilterController>();
            ...
            child: Obx(() => Column(
              ...
              children: [
                ...
                InputTap(
                  ...
                  onTap: () => _showDatePicker(context, _rembursmentSummaryFilterCt.startDate.value, (date) {
                    _rembursmentSummaryFilterCt.setStartDate(date);
                  }),
                  rightIcon: '',
                  leftSize: Size(14.w, 16.h),
                  value: _rembursmentSummaryFilterCt.startDate.value,
                ...
                InputTap(
                  ...
                  onTap: () => _showDatePicker(context, _rembursmentSummaryFilterCt.endDate.value, (date) {
                    _rembursmentSummaryFilterCt.setEndDate(date);
                  }),
                  rightIcon: '',
                  leftSize: Size(14.w, 16.h),
                  value: _rembursmentSummaryFilterCt.endDate.value,
                  leftIcon: 'assets/images/fa-solid_calendar-day.svg',
                ),
                SizedBox(height: 24.h,),
                Row(
                  children: [
                    Expanded(
                      child: ButtonLoading(
                        ...
                        loading: false,
                        verticalPadding: 7.h,
                        onTap: () => _rembursmentSummaryFilterCt.filter(),
                    ...
                    Expanded(
                      child: ButtonLoading(
                        ...
                        loading: false,
                        verticalPadding: 7.h,
                        onTap: () => _rembursmentSummaryFilterCt.reset(),
                        textStyle: ThemeTextStyle.biryaniSemiBold.apply(fontSizeDelta: 10.ssp, color: Colors.white),
                      ),
                    ),
                  ],
